...
export function registerDebugTools(server: McpServer): void {
  ...
  server.tool(
    "metro_logs",
    "Reads console logs from a React Native app via the Metro CDP debugger. If webSocketDebuggerUrl is omitted, auto-discovers via metro_apps and uses the first connected app. Reports which app was chosen.",
    {
    ...
    async ({ webSocketDebuggerUrl, port, durationMs, maxLogs }) => {
      ...
      let chosenApp: string | undefined;
