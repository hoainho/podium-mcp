...
export function registerValidateTools(server) {
    server.tool("validate_flow", "Returns a trustworthy, evidenced verdict on whether a just-implemented flow works. Runs your " +
        ...
        for (const a of asserts) {
            if (!a.text && !a.selector)
                return errorResult("validate_flow: each assertion needs text or selector.");
