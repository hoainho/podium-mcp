...
[![CI](https://github.com/nhonhgeargame/podium-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/nhonhgeargame/podium-mcp/actions/workflows/ci.yml)
...
```
/plugin marketplace add github:nhonhgeargame/podium-mcp
...
```bash
git clone git@github.com:nhonhgeargame/podium-mcp.git
cd podium-mcp
npm install
npm run build
```
...
[MIT](LICENSE) © 2026 nhonhgeargame
